...
export default function App() {
  ...
  // useMemo to prevent re-creation of radio buttons on each render
  ...
  // Resets app state to initial values for the home screen
  ...
  function orderReviewHandler() {
   ...
   // Dynamic screen rendering based on currentScreen state
  let screen = (
    <Homescreen
